<template>
    <div id="index">
        <div class="empty" v-if="questionnaireList.length === 0">
            <button type="button" @click.stop="createQuest">新建试卷</button>
        </div>
                ...
                <tbody>
                    <tr v-for="questionnaire in questionnaireList" class="quest"
                        ...
                        <td v-if="questionnaire.state==='未发布'" >
                            <button data-operation="preview">预览试卷</button>&nbsp;&nbsp;&nbsp;
                            <button data-operation="edit">编辑试卷</button>
                        </td>
                        <td v-else>
                            <button data-operation="preview">预览试卷</button>&nbsp;&nbsp;&nbsp;
                    ...
                    <tr class="last-row" @click="createOrRm($event)">
                        ...
                        <td colspan="3" class="center">
                            <button type="button" data-operation="create">新建试卷</button>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    export default {
        ...
        methods: {
            ...
            handleChecked(questionnaire) {
                ...
                // 每次点击checkbox，如果该试卷在选中的试卷列表中则在列表中删除该问卷
                // 如果不在列表中，则添加该试卷到列表
                if(index === -1) {
