    ...
    <div id="create">
        <div class="quest">
            <div class="quest-title">
                <input type="text" class="quest-title_input" placeholder="请输入的标题"
        ...
        <div class="submit">
            <div class="deadline">
                <label>测验截止日期：</label>
                <input type="text" placeholder="点击选择测验截止日期" readonly 
                    v-el:deadline
            ...
            <div @click="submit($event)">
                <button type="button" data-operation="save">保存试卷</button>
                <button type="button" data-operation="publish">发布试卷</button>
            </div>
        </div>
    </div>
</template>
